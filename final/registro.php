...
<body>
  ...
  <div class="login-container">
    ...
    <form action="Guarregistro.php" method="POST"  enctype="multipart/form-data" class="form" >
        ...
        <button type="button"  class="boton" onclick="location.href='index.php';">volver</button>
