...
<body>
    ...
    <form class="form">
        ...
        <div class="form__container">
            ...
            <div class="form__group">
                <input type="text" id="DNI" class="form__input" placeholder="" >
                <label for="DNI" class="form__label">DNI</label>
                <span class="form__line"></span>
            </div>
            <div class="form__group">
                <input type="text" id="Edad" class="form__input" placeholder="" >
                <label for="Edad" class="form__label">Edad</label>
                <span class="form__line"></span>
            </div>
            <div class="form__group">
                <input type="text" id="Peso" class="form__input" placeholder="" >
                <label for="Peso" class="form__label">Peso</label>
                <span class="form__line"></span>
            </div>
            <div class="form__group">
                <input type="text" id="Obra_social" class="form__input" placeholder="" >
                <label for="Obra_social" class="form__label">Obra social</label>
                <span class="form__line"></span>
            </div>
            <div class="form__group">
                <input type="text" id="Medicacion" class="form__input" placeholder="" >
                <label for="Medicacion" class="form__label">Medicacion</label>
                <span class="form__line"></span>
            </div>
            <div class="form__group">
                <input type="text" id="Area" class="form__input" placeholder="" >
                <label for="Area" class="form__label">Area</label>
                <span class="form__line"></span>
            </div>
            <div class="form__group">
                <input type="text" id="Enfermero" class="form__input" placeholder="" >
