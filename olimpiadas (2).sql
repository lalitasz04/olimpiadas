...
--
-- Servidor: localhost
-- Tiempo de generación: 27-09-2023 a las 18:59:53
...
INSERT INTO `Paciente` (`id`, `nombre`, `apellido`, `DNI`, `edad`, `peso`, `obra_social`, `medicacion`, `sintomas`, `tipo_llamada`, `area`, `enfermero`) VALUES
(24, 'rosa', 'gonzales', 32366254, 96, 75, 'si', 'no', 'dolor de espalda', 'normal', 'recepcion', 'sanchez '),
(27, 'carlos', 'perez', 5855665, 68, 98, 'si', 'si', 'dolor en el higado', 'emergencia ', 'cirugia', 'lopez');
